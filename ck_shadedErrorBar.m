function H=ck_shadedErrorBar(x,y,errBar,lineProps,transparent)
...
if isempty(lineProps)
    H.mainLine=plot(x,y,'LineWidth',2);
else
...
patchSaturation=0.45; %How de-saturated or transparent to make patch
if transparent
...
delete(H.mainLine)
if isempty(lineProps)
    H.mainLine=plot(x,y,'LineWidth',1);
else
	H.mainLine=plot(x,y,lineProps{:},'LineWidth',1);
end
